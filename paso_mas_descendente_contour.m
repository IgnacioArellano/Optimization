function paso_mas_descendente_contour
...
f=U2(x1,x2);
figure('color',[1 1 1])
contour(x1,x2,f,30), shading interp
hold on
plot(-1,1,'ko', 'MarkerSize',10,'markerfacecolor',[0 0 0])
plot(0.5,0,'ro', 'MarkerSize',10,'markerfacecolor',[1 0 0])
